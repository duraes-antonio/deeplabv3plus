...
_MAPILLARY_VISTAS = 'mvd'
_PASCAL = 'pascal'
_WINTER_CITY = 'winter_city'
...
def create_winter_city_label_colormap():
  """Creates a label colormap used in winter city segmentation benchmark.
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _WINTER_CITY:
    return create_winter_city_label_colormap()
  else:
